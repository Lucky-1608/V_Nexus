        ...
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
          <div className="container px-6 mx-auto relative z-10">
            <div className="flex flex-col items-center text-center gap-8 max-w-4xl mx-auto">
              ...
              >
                Master Your Life <br />
                with <span className="text-primary italic">Nexus</span>
              </motion.h1>
        ...
        <section id="features" className="py-24 bg-background/30 backdrop-blur-sm border-t border-white/5">
          <div className="container px-6 mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-muted-foreground text-lg">Stop juggling multiple apps. Nexus brings your entire digital life into one cohesive, intelligent system.</p>
            </div>
          ...
          <div className="container px-6 mx-auto relative z-10">
            <div className="bg-gradient-to-br from-primary/10 to-transparent border border-primary/20 rounded-3xl p-8 md:p-16 text-center overflow-hidden relative">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
                Join thousands of users who have transformed their productivity with Nexus.
